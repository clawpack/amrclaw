...
NoQuery = 0;                 % Query user for next plot.

OutputFlag = 'ascii';        % Read fort.qXXXX files.
OutputDir = './_output';     % Location of simulation output files
...
ContourValues = [];   % Draw contour lines in afterframe using drawcontourlines
