...
adjoint_output = os.path.abspath('acoustics_1d_forwardprob/adjoint/_output')
...
#------------------------------
    ...
    rundata.gaugedata.gauges.append([1, -2.5, 0., 1e9])
    rundata.gaugedata.gauges.append([2, -1.75, 0., 1e9])
    ...
    # need 3 values, set in setadjoint
