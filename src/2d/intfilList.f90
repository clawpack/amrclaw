...
!
!  THIS VERSION uses boundary lists for each grid, instead of
!  looping over all grids at this level
!
...
! :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::;
!
subroutine intfilList(val,mi,mj,time,flaguse,nrowst,ncolst,ilo,ihi,jlo,jhi,level,nvar,naux,msrc)
    ...
    use amr_module, only: bndListNum, bndListSt, nextfree, bndList, gridNbor
    ...
    integer :: bndLoc, bndNum, nextSpot, icount, msrc
...
!   do while (mptr /= 0)
    ...
    do icount = 1, bndNum
        mptr = bndList(nextSpot, gridNbor)   ! get the grid
